                    ...
                    <div class="row">
                                ...
                                <select name="pemilik_id" id="pemilik_id" name="pemilik_id" class="form-select">
                                    @foreach ($pemilik as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $item->id == $villa->pemilik_id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_villa" id="nama_villa" required
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="status" id="status" class="form-select" required>
                                    ...
                                    <option {{ $villa->status == 'Terisi' ? 'selected' : '' }} value="Terisi">Terisi
                                    </option>
                                </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="daya_tampung" id="daya_tampung"
                                    required placeholder="Masukkan Jumlah Daya Tampung"
                                    value="{{ $villa->daya_tampung }}">
                            </div>
                            <div class="mb-3">
