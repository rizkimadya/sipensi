...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-3">
            <div class="card p-md-5 shadow-lg p-4 mb-md-5 mb-3">
            ...
            <div class="card p-md-5 shadow-lg p-4 mb-md-5 mb-3">
                <div class="d-flex align-items-center">
                    ...
                    <span class="menu-icon ms-auto">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                        <span class="svg-icon svg-icon-2">
                            <svg id="pemilik" width="24" height="24" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <style>
                                    #pemilik {
                                        fill: #e78b12
                ...
                <span class="text-gray-700 pt-1 fw-semibold fs-6">Jumlah Pemilik Villa</span>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card p-md-5 shadow-lg p-4 mb-md-5 mb-3">
                <div class="d-flex align-items-center">
                    ...
                    <span class="menu-icon ms-auto">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                        <span class="svg-icon svg-icon-2">
                            <svg id="penyewa" width="24" height="24" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <style>
                                    #penyewa {
                                        fill: #1e33f7
                ...
                <span class="text-gray-700 pt-1 fw-semibold fs-6">Jumlah Penyewa</span>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card p-md-5 shadow-lg p-4 mb-md-5 mb-3">
